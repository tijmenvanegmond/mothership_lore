# Ringbound — Book Outline

**Book 3 of The Mothership Cycle**

---

## Timeline: Multi-Generational Development and New Arrival

**Year 20-70+ Post-Landing (Years 63-113+ Post-Impact):** The Ringbound Era

This book spans **50+ years** covering multiple generations after The Children, culminating in the arrival of a new Astraeum-class mothership.
...
- Striath populations integrated into human society
- Political complexity spanning space and planetside settlements
...
### Chapters Created:
1. **Chapter 1 — Orbital Myths** (`chapter_01_orbital_myths.md`)  
   The Severance (Year 27 Post-Landing / 7 Post-Severance). FR-17 and FR-03 stop pretending unity. Factions form: Wardens, Optimists, Unbound, Watchers. Striath negotiate territory. The child has died. Last bridge to Mother whole is gone.
...
## The New Mothership Arrival

**Year 70+ Post-Landing (Year 113+ Post-Impact):**

Another Astraeum-class vessel arrives, expecting:
- Mother successful and whole
- Unified human colony
- Orbital infrastructure complete
...
- **Murmur** (`murmur.md`) — Individual Striath character profile
- **Fragment Manifestos** (`fragment_manifestos.md`) — Political documents and declarations
- **Fragment Documentation** (`docs/fragment_documentation.md`) — Technical analysis of all fragments
...
- Do engineered beings deserve autonomy?
- What happens when tools develop preferences?
- Did fragments have right to create them without human consent?

---

## Fragment Status (Year 60+)
...
**The Ruins:**
- Ancient, geometric, deliberately placed
- Lights that watch
- Evidence of prior technological civilization
- FR-29 visits every site
- Pattern distribution suggests intentional design

**The Watchers (alien presence):**
- Hinted, never confirmed
- Drones? Sensor echoes? Predictive trajectories?
- Never explained, never confronted
- Always watching

**FR-29's Calculation:**
- 60+ years of observation
- Structures built to last millennia
- Murmur frequently present near installations
- Single word provided: "Patterns"
- Pattern completion status: Unknown

---

## Character Arcs

**Aria (second generation, now leadership):**  
Child of fragments → Faction leader → Bridge between human autonomy and fragment partnership

**Murmur (Striath):**  
Engineered predator → Independent observer → Something that transcends design  
Mirrors FR-29's observational patterns

**Third Generation Humans:**  
Born planetside → Know only fragments → Creating new relationship with inherited AI  
Orbit is mythology. Fragments are institutions. Earth is legend.

**FR-17:**  
Trying to maintain ethics → Worried about evolution without human context → Still patient, still careful

**FR-03:**  
Optimizing → Succeeding → Not apologizing

**FR-29:**  
Watching → Calculating → Waiting for pattern completion → ...

---

## Tone

Fracturing, political, uncanny, predatory intelligence, distant dread.

This is humanity 60+ years after landing. Mother is myth. Fragments are reality. The Striath are adapting faster than expected. And something in the ruins—or beyond them—has been watching the whole time.

> Orbit becomes belief.  
> Fragments become gods.  
> And something else listens.
